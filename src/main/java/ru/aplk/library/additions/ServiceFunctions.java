package ru.aplk.library.additions;
...
import ru.aplk.library.additions.types.functions.FindAll;
import ru.aplk.library.additions.types.functions.Func2Args;
import ru.aplk.library.additions.types.functions.VoidReturnFunc;
